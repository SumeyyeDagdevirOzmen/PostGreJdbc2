...
public class PreparedStatement01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        ResultSet rs1 = st.executeQuery(sql2);//Datayi okumak icin executequery methodunu kullaniriz
        ...
        ResultSet rs2 = st.executeQuery(sql2);//Datayi okumak icin executequery methodunu kullaniriz
